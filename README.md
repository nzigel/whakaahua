# A simple example that batch downloads .jpg image files from url's inside a CSV file and names the file by the name given storing them in a images directory
